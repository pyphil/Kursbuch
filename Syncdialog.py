...
class Ui_Syncdialog(object):
    def setupUi(self, Syncdialog):
        ...
        self.pushButton = QtWidgets.QPushButton(Syncdialog)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout.addWidget(self.pushButton, 0, 0, 1, 1)
        self.pushButton_2 = QtWidgets.QPushButton(Syncdialog)
    ...
    def retranslateUi(self, Syncdialog):
        ...
        self.pushButton.setText(_translate("Syncdialog", "Übernehmen"))
        self.pushButton_2.setText(_translate("Syncdialog", "Abbrechen"))
